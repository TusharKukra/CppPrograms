...
int diameter(node* root){
    ...
    // Time Complexity : O(n) becoz we are calling height fxn n times and height fxn have: O(n) T.C .
}

/////////////////////////////////////////////////////////////////////////
// So to reduce the TC & for fast traversal of above Diameter function : we use Pair

// for diameter : we need (height of LST + height of RST), diameter left, diameter right.
class Pair{
    public:
    int height;
    int diameter;
